...
<!---------------------------------------------------------------------------------------->
              <grid-item
                ...
                <div class="Panel__setpoint">   </span></div>
...
<!---------------------------------------------------------------------------------------->
              <grid-item
                ...
                <div class="Panel__name">System Info</div>
...
<!---------------------------------------------------------------------------------------->
        <grid-item
          ...
          :h=stepsGrid[2].h
          :i=stepsGrid[2].i
          :isDraggable=stepsGrid[2].isDraggable>

          <div class="Panel__name">3</div>
          <div class="editButton">
...
<!---------------------------------------------------------------------------------------->
       <div class="gridtile">
        <grid-item
          ...
          :h=stepsGrid[3].h
          :i=stepsGrid[3].i
          :isDraggable=stepsGrid[3].isDraggable>

          <div class="Panel__name">4</div>
          <div class="editButton">
